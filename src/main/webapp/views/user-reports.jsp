...
<script type="text/javascript">
	...
	function getParams() {
		var selRptId = $("#report\\.id").val();
		document.location.href = "user-reports.htm?reportId="+selRptId;		
	}
	
	function runIt() {
		var form = document.getElementById("reportsForm");	

		form.action = 'runUserReport.htm?page=1';
		form.method = 'POST';			
		form.submit();		
	}
	function getClientUploadRepostDetails(id){
		...
		document.location.href="getUserUploadReportDetails.htm?brand="+brand+"&date="+date;
		
	}
	function getClientDistrReport(id){
		//alert(id);
		id = "tr_"+id;
		var brand = $("tr#"+id+" > td#brand").text();
		var date = $("tr#"+id+" > td#date").text();
		...
		document.location.href="userDistrreport.htm?brand="+brand+"&date="+date;
...
<div class="popup" id="distrreport" style="display: none;width: 60%;height: 60%;margin-left:262px;" >
	<div class="pp-header">
	...
	<div class="pp-body">
		  ...
		  <table width="100%"  class="grid grid_13">
						...
						<core:forEach items="${DistributionReports}" var="bean" varStatus="i">
								<tr class="odd">
									<td class="td_04"><div><core:out value="${bean.brandName}"></core:out></div></td>
									<td class="td_05"><div><core:out value="${bean.clientId}"></core:out></div></td>
									<td class="td_06"><div><core:out value="${bean.partner}"></core:out></div></td>
									<td class="td_07"><div><core:out value="${bean.date}"></core:out></div></td>
...
<div class="wrapper"> 
	...
	<div class="content_wrapper"> 
		...
		<ul class="ul_left_nav">
			...
			<li class="si_error_listings"><a href="user-errorlisting.htm">Listing Errors</a></li>
			<li class="si_reports selected"><a href="user-reports.htm">Reports</a></li>
		...
		<spring:form method="post" modelAttribute="reportForm" id="reportsForm">		
													...
													<core:if test="${i.index == 3}">
															<core:choose>
																<core:when test="${reportType eq 'DistributionReport' }">
																	<td class="td_01" id="distrbrand"><a href="#" onclick="getClientDistrReport(${loopStatus.index})"><core:out
																				value="${reportDataRow.field4}" /></a></td>
																</core:when>
																<core:otherwise>
																	<td class="td_01" id="distrbrand"><core:out
			...
			<div class="c_icons_wrapper">
				<a href="userreportxls.htm" class="lnk_convert_ico ico_xls">XLS</a>
			  <a href="userreportpdf.htm" class="lnk_convert_ico ico_pdf">PDF</a>
        ...
        <div class="sb_box_01 sb_box_h01">
			...
			<tbody>
				...
				<td class="td_02"><spring:input path="endDate" class="input_date_01" />
			        ...
			        <tr id="branddrop">
			      <td class="td_01"><label>Stores</label></td>
			      <td class="td_02">
			      <select name="client"  id="clientName">
									<option value="">SELECT STORES</option>
									
									<core:forEach items="${userstores}" var="client">
