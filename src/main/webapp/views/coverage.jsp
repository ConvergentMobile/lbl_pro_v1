...
function filterReport() {
	...
	document.location.href = "coverage.htm?s=" + store + "&&b="
			...
			<!-- wide_column -->
			  <div class="wide_column_wrapper report_container" style="background: #d7dbe0; margin-top:0px;padding-bottom: 20px; height: auto!important;">
					...
					<div class="box-report-graph">
								<h2>Coverage(%)</h2>
								<div style="width:70%; min-height: 250px; float: left;margin: 0 0 50px 0;" id="coverageContainer">
								</div>
...
$(function() {
	window.onload = function () {
		...
		var chart = new CanvasJS.Chart("coverageContainer", {
			...
			subtitles:[
				   		{
				   			text: "You currently have " + total + " listings out of a possible " + possible + " listings. ",
