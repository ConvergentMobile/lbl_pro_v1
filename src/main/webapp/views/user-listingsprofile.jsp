...
function sendSubmitResult(){
  var form = document.getElementById('editBusinessForm');
     form.action = "updateUserBusiness.htm";    
...
<div class="popup" id="cancelChanges" style="display: none;">
	...
	<div class="pp-body">
		<div class="buttons">
			<a href="dashboardUser.htm" class="btn_dark_blue_2">Ok</a>
							...
							<table  id="location_information" width="110%" class="grid grid_10">
								...
								<tbody>
									...
									<tr>
										...
										<td><span  style="color: red; font-size: 12px;">${clientId_Error}</span></td>
									</tr>
									<tr>
							...
							<table  id="enhanced_content" width="110%" class="grid grid_10">
								...
								<tbody>	
									...
									<tr>
										...
										<td class="td_02"><div><spring:textarea class="bussinessInfo" id="enhanced_content_field" rows="10" cols="30" path="businessDescription" /></div></td>
