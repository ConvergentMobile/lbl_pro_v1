...
document.location.href = "compareListingPdfExport.htm?store="
		+ store
		+ "&&directory="
		+ directory
		+ "&&brandname="
						...
						$("select#storevalue")
								.change(
										function() {
											...
											document.location.href = "compare-listings.htm?store="
													+ store
													+ "&&directory="
													+ directory
													+ "&&brandname="
	...
	<div class="wrapper">
		...
		<div class="content_wrapper no-sidebar">
			...
			<div class="content" id="id_content">
				...
				<a href="#" class="ico_pdf" onclick="exportCompareListPDF()">PDF</a>
					...
					<div class="box box_red_title listing_compare">
						<spring:form commandName="searchBusiness" method="post"
							...
							<core:forEach items="${lblportlisting}" var="lbllisting">
								...
								<!-- title -->
								<div class="box_title">
									<h2>Compare Listing Accuracy</h2>
					...
					<div class="box-compare-right">
						<input type="hidden" value="${brandname }" id="brandname"
							...
							<select name="directory" id="directory"  >
									...
									<core:if test="${directory eq 'foursquare'}">
									<option value="foursquare" >Foursquare</option>
										<option value="google">Google</option>
									...
									<core:if test="${directory eq 'usplaces'}">
									<option value="usplaces">Usplaces</option>
									...
									<core:if test="${directory eq 'yellowbot'}">
										<option value="yellowbot">Yellowbot</option>
									...
									<core:if test="${directory eq 'ezlocal'}">
									<option value="ezlocal">ezlocal</option>
