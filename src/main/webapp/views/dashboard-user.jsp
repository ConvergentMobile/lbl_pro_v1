...
function validateExtension(v)
{
 ...
 $(document).ready(function(){
	...
	function sendDeleteResult() {
		...
		form.action = "deleteUserBusinessInfo";
		form.submit();
	}
	...
	function sendEditResult() {
		...
		var form = document.getElementById('businessListform');
		form.action = "editUserBusinessInfo";
		form.submit();
	}
	...
	function sendExportSubmit() {
		...
		var form = document.getElementById('businessListform');
		form.action = "exportUserBusinessInfo";
		form.submit();
		 }
	}
...
<div class="wrapper"> 
	...
	<div class="content_wrapper no-sidebar"> 
		...
		<ul class="ul_left_nav">
			<li class="si_dashboard selected"><a href="dashboardUser.htm">Dashboard</a></li>			
		...
		<div class="content" id="id_content">
			...
			<div class="inner_box"> 
				...
				<div class="filters-2">
					...
					<a href="dashboardUser.htm"  class="btn_dark_blue_2">CLEAR FIlter</a>
				...
				<div class="box box_red_title business-listings"> 
					...
					<div class="box_title">
						...
						<div class="box_title_right"> <span>Locations With Errors: ${errorListSize}</span><a href="user-errorlisting.htm"  class="btr_button">FIX ERRORS</a> </div>
					</div>
					...
					<div id="id_business_listings-2">
						<table  id="businessTable" width="100%" class="grid grid_13">
							...
							<core:forEach items="${allBusinessInfo}" var="bean" varStatus="i">
									...
									<td class="td_02"><div><core:if test="${not empty bean.isCorrectFormat  }">
									<a href="#" style="color:red;font-size: 14px;"  onclick="showErrorMessage('${bean.inCorrectValues}','${bean.store}','${bean.id}');" >
									<img src="images/icon-!.png" align="!"></a></core:if></div></td>
