...
history.pushState(null, null, 'editErrorBusinessInfo.htm?listid='+listid);
...
<div class="popup" id="cancelChanges" style="display: none;">
	...
	<div class="pp-body">
		<div class="buttons">
			<a href="listing-error.htm" class="btn_dark_blue_2">Ok</a>
...
<div class="wrapper"> 
	...
	<div class="content_wrapper no-sidebar"> 
		...
		<div class="content" id="id_content">
			...
			<input type="hidden" value="${listIds }" id="listId">
					...
					<div class="box-content"  style="margin: 0px -80px 0px">
						<div class="bc-inner" id="location_profile">
							...
							<table  id="location_information" width="100%" class=" grid_10 localinfo">
								...
								<thead>
									<tr>
										<th class="th_01"><div>Location Information</div></th>
										<th class="th_02"><spring:hidden path="multiUpdateString"	id="multiUpdateString" /></div></th>
							...
							<table  id="social_links" width="100%" class=" grid_10 localinfo">
								...
								<thead>
									<tr>
										...
										<th class="th_02"> <div>Error Message</div></th>
									</tr>
								</thead>
								<colgroup>
									<col width="27%" />
							...
							<table  id="enhanced_content" width="100%" class=" grid_10 localinfo">
								...
								<tbody>	
									...
									<tr>
										...
										<td class="td_02"><div><spring:textarea class="bussinessInfo" id="enhanced_content_field"  rows="10" cols="30"  path="brands" style="padding-top: 0px; width:100%; height :60px;    "/></div></td>
