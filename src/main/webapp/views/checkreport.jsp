...
function clearSearch() {
	/* $("#searchAndFilterForm").attr('action',
	  ...
	  var form = document.getElementById('checkAndFilterForm');
	     form.action = "checkreportview.htm";
	     form.submit();
} 
 ...
 function downloadInfo(){	 
	...
	function sendEditResult(){
		...
		$.session.set("isSave",false);
		  var form = document.getElementById('businessListform');
		     form.action = "editcheckreportInfo";
		     form.submit();
		}
...
<div class="wrapper"> 
	...
	<div class="content_wrapper no-sidebar"> 
		...
		<ul class="ul_left_nav">
			...
			<li class="si_checkreport"><a href="checkreportview.htm">CheckReportList</a></li>
		</ul>
		<!-- // left side navigation --> 
		<!-- content area -->
		<div class="content" id="id_content">
			...
			<div class="subheader clearfix">
				<h1>Check Report Listing</h1>
				<p>${businessname}</p>
			</div>
			<!-- // subheader -->
			<div class="inner_box"> 
			  <spring:form method="post" action="checkreportsearch.htm" commandName="checkreportSearch"  id="searchAndFilterForm">
				<div class="filters-2">
				  <label>Brand Name&nbsp;<spring:input path="directory"  style="width:140px"/></label>
					<label>Business Name&nbsp;<spring:input path="businessname" style="width:140px"/></label>
					
					<label>Zip&nbsp;<spring:input path="zip" style="width:55px"/></label>
					<label>Phone #&nbsp;<spring:input path="phone" style="width:140px"/></label>
					<label>Address&nbsp;<spring:input path="address" style="width:140px"/></label>
					<label>City&nbsp;<spring:input path="city" style="width:100px"/></label>
					<label>State&nbsp;<!-- <select>
							<option></option>
						</select> --><spring:input path="state" style="width:100px"/>
					</label>
					
										
					<input type="submit" value="Apply FIlter" onclick="search()" class="btn_dark_blue_2">
					<a href="checkreportview.htm"   class="btn_dark_blue_2">CLEAR FIlter</a>
				...
				<input type="hidden" id="templateName" name="serviceName">						
					...
					<div id="id_business_listings" class="business_listings_cls">
						<table  id="businessTable" width="100%" class="grid grid_13">
							...
							<core:forEach items="${listOfCheckreportInfo}" var="bean" varStatus="i">
							
								<tr class="odd">
									<td class="td_01"><div><input type="checkbox" class="checkbox1"  value="${bean.listingId}" name="id"></div></td>
									<td class="td_02"><div></div></td>
									<td class="td_03"><div ><core:out value="${bean.directory}"></core:out></div></td>
									<td class="td_04"><div><core:out value="${bean.businessname}"></core:out></div></td>
									<td class="td_05"><div><core:out value="${bean.address}"></core:out></div></td>
									<td class="td_06"><div><core:out value="${bean.city}"></core:out></div></td>
									<td class="td_07"><div><core:out value="${bean.state}"></core:out></div></td>
									<td class="td_08"><div><core:out value="${bean.zip}"></core:out></div></td>
									<td class="td_09"><div><core:out value="${bean.phone}"></core:out></div></td>
									<td class="td_09"><div><core:out value=""></core:out></div></td>
								</tr>
