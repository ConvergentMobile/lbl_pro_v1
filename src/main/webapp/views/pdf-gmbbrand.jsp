			...
			<div class="inner_box">
				...
				<div class="box box_red_title box_report">
					...
					<div class="box-report-graph">
										<h2>Daily Trends</h2>
										<div style="width:20%; min-height: 250px; float: left;" id="dailyViewTrendsChartContainer">
											<!-- place for graphic -->
										</div>
										<div style="width:20%; min-height: 250px; float: left;" id="dailyActionTrendsChartContainer">
											<!-- place for graphic -->
										</div>
										<div style="width:20%; min-height: 250px; float: left;" id="dailyWebsiteTrendsChartContainer">
											<!-- place for graphic -->
										</div>
										<div style="width:20%; min-height: 250px; float: left;" id="dailyCallsTrendsChartContainer">
											<!-- place for graphic -->
										</div>
										<div style="width:20%; min-height: 250px; float: left;" id="dailyDrivingTrendsChartContainer">
											<!-- place for graphic -->
										</div>
...
var dailyViewTrendsDP = []; 
				
				var listDVT = ${dailyViewTrends};
				$.each(listDVT, function(dvti1, dvtv1) {
					//alert( index + ": " + value.toString() );
					dailyViewTrendsDP.push(dvtv1);
				}); 
				
				var viewText = "ONLINE VIEWS";
				var totalViews = ${viewCount};
				
				var dailyViewTrends = new CanvasJS.Chart("dailyViewTrendsChartContainer",
						    {
					 		 dataPointWidth: 15,
							 animationEnabled: true,
							 axisY : {
								...
								subtitles:[
								   		...
								   		{
								            text: CanvasJS.formatNumber(totalViews),
								            fontColor: "#75AA95",
											fontSize: 25
								 		 },
							   		],
						      data: [
							      ...
							      {        
							    	  type: "column",	
									  markerSize : 0,
									  dataPoints : dailyViewTrendsDP 
							      }   
						      ]
						    });

				dailyViewTrends.render();
				
				
				var dailyActionTrendsDP = []; 
				
				var listDAT = ${dailyActionTrends};
				$.each(listDAT, function(dati1, datv1) {
					//alert( index + ": " + value.toString() );
					dailyActionTrendsDP.push(datv1);
				}); 
				
				var totalActions =  ${actionCount};
				var actionText= "CUSTOMER ACTIONS";
				
				var dailyActionTrends = new CanvasJS.Chart("dailyActionTrendsChartContainer",
						    {
							 dataPointWidth: 15,
							 animationEnabled: true,
					            axisY : {
								...
								subtitles:[
									   		...
									   		{
									            text: CanvasJS.formatNumber(totalActions),
									            fontColor: "#75AA95",
												fontSize: 25
									 		 },
								   		],
						      data: [
							      ...
							      {        
							    	  type: "column",			
									  markerSize : 0,
									  dataPoints : dailyActionTrendsDP 
							      }   
						      ]
						    });

				dailyActionTrends.render();
				
				
				var dailyWebsiteTrendsDP = []; 
				
				var listDWT = ${dailyWebsiteTrends};
				$.each(listDWT, function(daWi1, daWv1) {
					//alert( index + ": " + value.toString() );
					dailyWebsiteTrendsDP.push(daWv1);
				}); 
				
				var webCount =  ${webCount};
				var webText= "WEBSITE CLICKS";
				
				var dailyWebTrends = new CanvasJS.Chart("dailyWebsiteTrendsChartContainer",
						    {
							 dataPointWidth: 15,
							 animationEnabled: true,
					            axisY : {
								...
								subtitles:[
									   		...
									   		{
									            text: CanvasJS.formatNumber(webCount),
									            fontColor: "#75AA95",
												fontSize: 25
									 		 },
								   		],
						      data: [
							      ...
							      {        
							    	  type: "column",			
									  markerSize : 0,
									  dataPoints : dailyWebsiteTrendsDP 
							      }   
						      ]
						    });

				dailyWebTrends.render();
				
				
				var dailyCallsTrendsDP = []; 
				
				var listDCT = ${dailyCallsTrends};
				$.each(listDCT, function(daci1, dacv1) {
					//alert( index + ": " + value.toString() );
					dailyCallsTrendsDP.push(dacv1);
				}); 
				
				var callCount =  ${callCount};
				var callText= "CALLS GENERATED";
				
				var dailyCallTrends = new CanvasJS.Chart("dailyCallsTrendsChartContainer",
						    {
							 dataPointWidth: 15,
							 animationEnabled: true,
					            axisY : {
								...
								subtitles:[
									   		...
									   		{
									            text: CanvasJS.formatNumber(callCount),
									            fontColor: "#75AA95",
												fontSize: 25
									 		 },
								   		],
						      data: [
							      ...
							      {        
							    	  type: "column",			
									  markerSize : 0,
									  dataPoints : dailyCallsTrendsDP 
							      }   
						      ]
						    });

				dailyCallTrends.render();
				
				
				var dailyDirectionsTrendsDP = []; 
				
				var listDDT = ${dailyDrivingTrends};
				$.each(listDDT, function(dadi1, dadv1) {
					//alert( index + ": " + value.toString() );
					dailyDirectionsTrendsDP.push(dadv1);
				}); 
				
				var dirCount =  ${dirCount};
				var dirText= "DRIVING DIRECTIONS";
				
				var dailyDirTrends = new CanvasJS.Chart("dailyDrivingTrendsChartContainer",
						    {
							 dataPointWidth: 15,
							 animationEnabled: true,
					            axisY : {
								...
								subtitles:[
									   		...
									   		{
									            text: CanvasJS.formatNumber(dirCount),
									            fontColor: "#75AA95",
												fontSize: 25
									 		 },
								   		],
						      data: [
							      ...
							      {        
							    	  type: "column",			
									  markerSize : 0,
									  dataPoints : dailyDirectionsTrendsDP 
							      }   
						      ]
						    });

				dailyDirTrends.render();
