...
function getPdfCitationReport(){
	...
	document.location.href =  "citationPdfReport.htm?brand="+brandname;
}
function loadmorestores() {
	var brandname=$('#brandname').val();
	//alert(brandname);

	document.location.href =  "loadmore-reports-citation.htm?brand="+brandname;
	}
					...
					<div id="id_citation_report">
						<table width="100%" class="grid grid_16">
							...
							<input type="hidden" name="brandname" value="${brandname}" id="brandname"> 
								...
								<tr class="odd">
									<td class="td_01"><div>
									<a href="<core:url value="reportbyStorecitation.htm?store=${bean.store}&&brandname=${brandname}"/>">${bean.store}</a></div></td>
									...
									<td class="td_05"><div>	<a href="<core:url value="reportbyStorecitation.htm?store=${bean.store}&&brandname=${brandname}"/>">${bean.pathCount}</a></div></td>
