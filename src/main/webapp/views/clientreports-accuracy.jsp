...
function sortBystore(flag){
	...
	document.location.href = "clientsByStore.htm?brand="+brandname+"&&flag="+flag;	
}
function sortByPercentage(flag){
	var brandname=$('#brandname').val();
	//alert(brandname);

	document.location.href = "clientsByAccracy.htm?brand="+brandname+"&&flag="+flag;	
}
function sortgoogle(flag){
	var brandname=$('#brandname').val();
	//alert(brandname);

	document.location.href = "clientsByGoolge.htm?brand="+brandname+"&&flag="+flag;	
}
function sortbing(flag){
	var brandname=$('#brandname').val();
	//alert(brandname);

	document.location.href = "clientsByBing.htm?brand="+brandname+"&&flag="+flag;	
}
function sortYahoo(flag){
	var brandname=$('#brandname').val();
	//alert(brandname);

	document.location.href = "clientsByYahoo.htm?brand="+brandname+"&&flag="+flag;	
}
function sortYelp(flag){
	var brandname=$('#brandname').val();
	//alert(brandname);

	document.location.href = "clientsByYelp.htm?brand="+brandname+"&&flag="+flag;	
}
function sortYp(flag){
	var brandname=$('#brandname').val();
	//alert(brandname);

	document.location.href = "clientsByYp.htm?brand="+brandname+"&&flag="+flag;	
}
function sortCitySearch(flag){
	var brandname=$('#brandname').val();
	//alert(brandname);

	document.location.href = "clientsByCitySearch.htm?brand="+brandname+"&&flag="+flag;	
}
function sortMapQuest(flag){
	var brandname=$('#brandname').val();
	//alert(brandname);

	document.location.href = "clientsByMapQuest.htm?brand="+brandname+"&&flag="+flag;	
}
function sortSuperPages(flag){
	var brandname=$('#brandname').val();
	//alert(brandname);

	document.location.href = "clientsBySuperPages.htm?brand="+brandname+"&&flag="+flag;	
}
function sortYellowBook(flag){
	var brandname=$('#brandname').val();
	//alert(brandname);

	document.location.href = "clientsByYellowBook.htm?brand="+brandname+"&&flag="+flag;	
}
function sortWhitePages(flag){
	var brandname=$('#brandname').val();
	//alert(brandname);

	document.location.href = "clientsByWhitePages.htm?brand="+brandname+"&&flag="+flag;	
}
	 ...
	 // $(".loading").removelass("dsp_None");
		...
		$("select#store").change(function() {
			  var brandname=$('#brandname').val();
			   ...
			   document.location.href = "getClientListingByStore.htm?store="+store+"&&brand="+brandname+"&&percentage="+percentage;
		});
 ...
 $(document).ready(function() {
	...
	function loadmorestores() {
		...
		document.location.href = "clientload-morestore.htm?brand="+brandname;	
	...
	function accuracyXLs() {
		var brandname=$('#brandname').val();
			...
			document.location.href = "clientaccuracyreportxls.htm?brand="+brandname;	
		...
		<div class="content" id="id_content">
			...
			<div class="inner_box"> 
				...
				<div class="box box_red_title report_accuracy"> 
					...
					<div class="box_title">
						...
						<div class="box_title_right btr_2">
							<form class="box_title_form">
								<a href="#" onclick="runaccuracyreport()" class="lnk">Clear Filter</a>
									<select
										name="store" id="store" class="selectjs"
										style="width: 150px; margin: 0px 90px 0px;">
					...
					<!-- // title -->
					<div class="box-subtitle-1 pl30">Visibility - <a href="">10 Sources</a></div>
							...
							<core:set
							 ...
							 <core:when
								...
								<span>${avgAccuracy}%</span>
									...
									<span>${avgAccuracy}%</span></core:otherwise>
									</core:choose>
					...
					<table width="100%" class="grid grid_18">
						...
						<thead>
							...
							<tr>
								...
								<th class="th_04 up"><div onclick="sortbing('${flagvalue}')"><img src="images/logo-acc-02.png"></div></th>
								...
								<th class="th_04 down"><div onclick="sortSuperPages('${flagvalue}')"><img src="images/logo-acc-08.png"></div></th>
								<th class="th_04 down"><div onclick="sortYellowBook('${flagvalue}')"><img src="images/logo-acc-09.png"></div></th>
								<th class="th_04 down"><div onclick="sortWhitePages('${flagvalue}')"><img src="images/logo-acc-10.png"></div></th>
							</tr>
						</thead>
					</table>
										...
										<tr class="odd ">
											...
											<td class="td_01"><div>
													<input type="hidden" name="brandname"
														...
														href="<core:url value="clientcheckreportview.htm?store=${accuracy.store}&&brandname=${accuracy.brandname}"/>">${accuracy.store}</a>
											...
											<core:set value="${accuracy.bingColourCode}"
											...
											<core:set value="${accuracy.superpagesColourCode}"
												var="superpagesErrorsCount"></core:set>
											<core:set value="${accuracy.yellowbookColourCode}"
												var="yellobookErrorsCount"></core:set>
											<core:set value="${accuracy.whitepagesColourCode}"
					...
					<div class="box-legend">
						 	<span style="text-align: left;" id="loadmore1"> <core:if
									test="${mode eq 'mode' }">
									<span id="loadmore" onclick="loadmorestores()" style="color: red; margin-right: 300px">Load More</span>
								</core:if> </span>
