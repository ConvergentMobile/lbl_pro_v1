...
<script src="rjs/charts3.js"></script>
			...
			<div class="inner_box"> 
				...
				<div class="box box_red_title report_accuracy"> 
					...
					<table class="brand_report white">
						...
						<tr>
						<input type="hidden" value="${averageAccuracy }" id="averageAccuracy">
							<td class="td_01">
								<h1>Your Brand Accuracy</h1>
				...
				<div class="box"> 
						<input type="hidden"  id="googleErrors" value="${googleErrors}" />
							<input type="hidden"  id="bingErrors" value="${bingErrors}" />
							<input type="hidden"  id="yelpErrors" value="${yelpErrors}" />
							<input type="hidden"  id="YahooErrors" value="${YahooErrors}" />
							<input type="hidden" id="ypErrors" value="${ypErrors}" />
							<input type="hidden"  id="citysearchErrors" value="${citysearchErrors}" />
							<input type="hidden"  id="mapquestErrors" value="${mapquestErrors}" />
							<input type="hidden"  id="superpagesErrors" value="${superpagesErrors}" />
							<input type="hidden"  id="yellobookErrors" value="${yellobookErrors}" />
							<input type="hidden"  id="whitepagesErrors" value="${whitepagesErrors}" />	
