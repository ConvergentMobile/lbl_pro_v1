...
function validateExtension(v)
{
 ...
 function showExportPopup(){
	...
	function sendDeleteResult() {
		...
		form.action = "deleteuserErrorInfo";
		form.submit();
	}
...
<div class="popup" id="showuploadpopup" style="display: none">
	...
	<spring:form action="uploadBusiness.htm?page=dashboardclient" commandName="uploadBusiness"
			enctype="multipart/form-data">  <!--  onsubmit="javascript:return checkFileFormat(this);" -->
		<div class="upload">
		...
		<div class="content" id="id_content">
			...
			<div class="inner_box"> 
				...
				<div class="filters-2">
					...
					<a href="user-errorlisting.htm"  class="btn_dark_blue_2">CLEAR FIlter</a>
