...
<div class="popup" id="cancelChanges" style="display: none;">
	...
	<div class="pp-body">
		<div class="buttons">
			<a href="listingClient-error.htm" class="btn_dark_blue_2">Ok</a>
...
<div class="wrapper"> 
	<!-- header -->
	<div class="header"> <a href="dashboardUser.htm" class="logo_lbl">Local Business Listings</a>
		<ul class="top_nav">
			<li class="home"><a href="dashboardUser.htm">Home</a></li>
			<li class="help"><a href="userHelp.htm">Help</a></li>
	...
	<div class="content_wrapper no-sidebar"> 
		...
		<ul class="ul_left_nav">
			<li class="si_dashboard"><a href="dashboardUser.htm">Dashboard</a></li>			
			<li class="si_error_listings selected"><a href="user-errorlisting.htm">Listing Errors</a></li>
			<li class="si_reports"><a href="user-reports.htm">Reports</a></li>			
			<!--  <li class="si_toolbox"><a href="userToolbox.htm">Convergent Toolbox</a></li>-->
		</ul>
		<!-- // left side navigation --> 
		<!-- content area -->
						...
						<div class="bc-inner" id="location_profile">
							...
							<table  id="location_information" width="110%" class="grid grid_10">
								...
								<tbody>
									...
									<tr>
										<td class="td_01"><div><tag:message code="businessApp.lable.ActionCode">
																</tag:message><span style="color: red">*</span></div></td>
										<td class="td_02"><div><spring:input class="bussinessInfo" path="actionCode" id="location_information_field"  /></div></td>
										<td><span  style="color: red">${actionCode_Error}</span></td>
									</tr>
										...
										<tbody>
											...
											<tr>
												...
												<td class="td_02"><div>
														<spring:textarea class="bussinessInfo"
															id="enhanced_content_field" rows="20" cols="40"
															path="products" />
													</div></td>
											...
											<tr>
												...
												<td class="td_02"><div>
														<spring:textarea class="bussinessInfo"
															id="enhanced_content_field" rows="20" cols="40"
															path="productsOrServices_combined" />
													</div></td>
