...
public interface BusinessService {
	...
	public List<LocalBusinessDTO> getSpecificBusinessInfo(List<Integer> listIds, String services);
	...
	public ChangeTrackingEntity isClientIdAndStoreExists(Integer clientId, String store);
	...
	public Map<String, Long> getInsightsDataForBrandAndStore(String brand, String store, Date startDate, Date endDate);
