...
public interface BusinessService {
	...
	public List<LocalBusinessDTO> getSpecificBusinessInfo(List<Long> listIds, String services);

	public Set<LocalBusinessDTO> searchBusinessinfo(String companyName, String store, String locationPhone,
			String brands);

	public Set<LocalBusinessDTO> businesSearchInfo(String brands, String companyName, String store,
			String locationPhone, String locationAddress, String locationCity, String locationState,
	...
	public boolean updateChannel(String channelName, Date startDate, Integer channelID, String imagePath);

	public BrandInfoDTO getBrandByBrandNameAndPartner(String brandName, String submission);

	public boolean saveBrand(String brandName, Date startDate, String locationsInvoiced, String submisions,
			Integer channelID, String partnerActive, Integer clientId, int brandId);

	public boolean updateBrand(Integer brandID, String brandName, Date startDate, String locationsInvoiced,
			String submisions, Integer channelID, String partnerActive, Integer clientId, Integer id);

	public boolean saveBrandDetails(String channelName, String brandName, Date startDate, String locationsInvoiced,
			String submisions);
	...
	public boolean isValidState(String state, String countyCode);
	...
	public Set<LblErrorDTO> errorBusinesSearchInfo(String brands, String companyName, String store,
			String locationPhone, String locationAddress, String locationCity, String locationState,
			String locationZipCode);

	public void deleteErrorBusinessInfo(List<Long> listIds);

	public void updateBusinessRecords(List<LocalBusinessDTO> updateBusinessRecords, Date date, String uploadJobId,
			String userName);

	public void deleteBusinessByActionCode(List<LocalBusinessDTO> listofDeletesbyActionCode);

	public void deleteErrorBusinessByActioncode(List<LblErrorDTO> listofErrorDeletesbyActionCode);

	public void updateErrorBusinessByActionCode(List<LblErrorDTO> listOfErrorUpdaatesByActionCode, Date date,
			String uploadJobId);
	...
	public String getSyphCodeByClientAndCategoryID(String category, Integer clientId);
	...
	public boolean saveBrand(String brandName, Date startDate, String locationsInvoiced, String submisions,
			Integer channelID, String partnerActive, Integer clientId, int brandId, String email, String imagePath);

	public boolean updateBrand(Integer brandID, String brandName, Date startDate, String locationsInvoiced,
			String submission, Integer channelID, String partnerActive, Integer clientId, Integer id, String email);
	...
	public List<LocalBusinessDTO> getCLientListOfBusinessInfo(String client, String templateName);
	...
	public BrandInfoDTO getBrandInfoByBrandName(String brandName, String channelName);
	...
	public Set<LocalBusinessDTO> searchBusinessListinginfo(String store, String brands);
	...
	public boolean updateBrand(Integer brandID, String brandName, Date startDate, String inactive,
			String locationsInvoiced, String submission, Integer channelID, String partnerActive, Integer clientId,
			Integer id, String email, String imagePath);

	public String getGoogleCategory(String category1);

	public boolean isClientIdExistis(Integer clientId);

	public List<LocalBusinessDTO> getListOfBusinessInfoOrederByStore(String flag, String companyname,
			String searchType);

	public List<LocalBusinessDTO> getListOfBusinessInfoOrederByPhone(String flag, Map<String, String> fmap);

	public List<LocalBusinessDTO> getListOfBusinessInfoOrederByZip(String flag, Map<String, String> fmap);

	public List<LocalBusinessDTO> getListOfBusinessInfoOrederByState(String flag, Map<String, String> fmap);

	public List<LocalBusinessDTO> getListOfBusinessInfoOrederByCity(String flag, Map<String, String> fmap);

	public List<LocalBusinessDTO> getListOfBusinessInfoOrederByAddress(String flag, Map<String, String> fmap);

	public List<LocalBusinessDTO> getListOfBusinessInfoOrederByBusinessName(String flag, Map<String, String> fmap);

	public List<String> getStoreBasedOnBrandsandStore(String brandname, String store);
	...
	public List<LocalBusinessDTO> getAllBusinessListingsSortBytotallocations(String flag);

	public List<ExportReportDTO> getListingActivityInf(String flag);

	public List<CustomSubmissionsBean> getSearchBrandandChannelDetails(String channelName, String brandName1);

	public List<SearchDomainDTO> getDomainsByStore(String store, String domain);

	public List<LocalBusinessDTO> getListOfBusinessInfoByStore(String flag, Map<String, String> fmap);
	...
	Map<Integer, List<ChangeTrackingDTO>> getBusinessListing(List<String> listofStores, String brand, Date fromDate,
			Date toDate);
	...
	public ChangeTrackingEntity isClientIdAndStoreExists(Integer clientId, Long lblStoreId2);
	...
	public boolean isAbbreviationExist(String lastWordinDirectoryddress, String lastWordinLocationAddress);

	public LocalBusinessDTO getBusinesslistingBystore(String store);

	public void updateCustomSubmissions(CustomSubmissionsDTO schedulerDTO, String brandName);

	public List<LocalBusinessDTO> getListOfBusinessInfoForExport(String templateName);

	public Integer getlocationInvoicedByClient(Integer clientId);

	public List<BrandInfoDTO> getClientNamesByBrand(String brand);

	public List<BrandInfoDTO> getChannelBasedClientsByBrand(String channelName, String brand);
	...
	public Map<String, Integer> getPathCountMapForStores(String store, Integer brandID);

	public List<CitationReportDTO> getListOfCitationInfo(String brandname);

	public Map<String, Integer> getPathCountMapForStores(List<LocalBusinessDTO> listOfBussinessinfo);
	...
	public CitationReportDTO getCitationInfoInfoByStore(String store, String brandname);
	...
	public void saveAccuracyPercentageInfo(AccuracyPercentageEntity percentageEntity);
	...
	public void addErrorToBusinessList(LocalBusinessDTO localBusinessDTO, Date date, String string,
			List<Long> listIds);

	public List<ValueObject> getData(String string, String string2);

	public List<ValueObject> getComapareListData(String storeId, String directory, String brandname);

	public List<ValueObject> getDS(String storeId, String directory, String brandname);

	public List<AuditEntity> getListOfOverridenListingsByBrand(Date fromDate, Date toDate, String brand);

	public List<AuditEntity> getListOfOverridenListings(Date fromDate, Date toDate);

	public List<RenewalReportDTO> runRenewalReport(Date fromDate, Date toDate, String storeName, String brand);

	public List<RenewalReportDTO> runRenewalReportForBrand(Date fromDate, Date toDate, String brand);
	...
	public LocalBusinessDTO getBusinessListinginfo(String store, String brandname);

	public List<LblErrorDTO> getListOfBusinessErrorInfoByStore(String flag, Map<String, String> fmap);

	public List<LblErrorDTO> getListOfBusinessErrorInfoByBusinessName(String flag, Map<String, String> fmap);

	public List<LblErrorDTO> getListOfBusinessErrorInfoByAddress(String flag, Map<String, String> fmap);

	public List<LblErrorDTO> getListOfBusinessErrorInfoByCity(String flag, Map<String, String> fmap);

	public List<LblErrorDTO> getListOfBusinessErrorInfoByState(String flag, Map<String, String> fmap);

	public List<LblErrorDTO> getListOfBusinessErrorInfoByZip(String flag, Map<String, String> fmap);

	public List<LblErrorDTO> getListOfBusinessErrorInfoByPhone(String flag, Map<String, String> fmap);
	...
	public Integer getCountForBrand(Integer clientId, List<UploadBusinessBean> listDataFromXLS);
	...
	public Map<String, Long> getInsightsDataForBrandAndStore(Integer brandId, String store, Date startDate, Date endDate);

	public List<String> getAllStates();

	public List<InsightsGraphDTO> getViewsHistoryByWeek(String state, String brand, String store, Date startDate, Date endDate);
	...
	public void deleteExistingRecords(Integer clientId,
			java.util.Date formattedEndDate);
	...
	public void deleteExistingRecords(Integer clientId,
			java.util.Date formattedDate, java.util.Date formattedDate2);

	public Long getInsightCountsForBrand(Integer brandId, String store, Date startDate, Date endDate);
