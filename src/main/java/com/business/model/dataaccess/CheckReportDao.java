...
public interface CheckReportDao {
	...
	public Set<CheckReportDTO> CheckReportSearchInfo(String store,
			String locationAddress,String brandname);
	...
	public List<AccuracyDTO> getSortByGoogleAccuracyListInfo(String brandName,
			String flag);
